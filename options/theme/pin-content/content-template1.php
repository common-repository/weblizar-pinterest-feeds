...
<?php } ?>
<?php }	else if($PFFREE_Access_Token!='') { ?>
		<div class="alert-danger col-md-12">	
			...
			<p style="color:red; text-align:center">
				<?php esc_html_e('Your Access Token is wrong or Your request limit is exhausted.', 	PFFREE_TEXT_DOMAIN );?></br>
				<b><?php esc_html_e('You should wait for 1 hour or less to get your limit back.', PFFREE_TEXT_DOMAIN );?></b>
			</p>
		</div>
		<?php
			$wl_pffree_options['pinterest_user_id'] = '';
			update_option('weblizar_pffree_options', $wl_pffree_options);
			} else if($PFFREE_Access_Token == '') {
				$wl_pffree_options['pinterest_user_id'] = '';
				update_option('weblizar_pffree_options', $wl_pffree_options);
			} 	
	} else { ?>
